...
async function testApp() {
    ...
    try {
        ...
        try {
            const testTx = await paymentService.createOfflinePayment("0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb", // Dirección de prueba
        ...
        try {
            const request = await paymentService.createPaymentRequest("0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb", "500000000000000000", // 0.5 tokens
            undefined, "Pago de prueba");
